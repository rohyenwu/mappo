...
def main():
    ...
    metric_specs = [
        ...
        ("mbps/mu_min_mld/total", "Min Arrival MLD", "mu_min_mld", "Throughput (Mbps)"),
        ("mbps/mu_mid_mld/total", "Mid Arrival MLD", "mu_mid_mld", "Throughput (Mbps)"),
        ("mbps/mu_max_mld/total", "Max Arrival MLD", "mu_max_mld", "Throughput (Mbps)"),
