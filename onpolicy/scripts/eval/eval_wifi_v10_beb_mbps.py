#!/usr/bin/env python
"""Evaluate a BEB baseline on WiFi v10 with fixed-duration Mbps metrics."""
...
def parse_args(args, parser):
    ...
    parser.add_argument("--wandb_project", type=str, default="WiFi_v10_beb_eval_mbps")
    parser.add_argument("--wandb_group", type=str, default="compare_wifi_v10_beb_mbps")
...
def main(args):
    ...
    run_dir = build_eval_run_dir(all_args, "wifi_v10_beb_mbps")
    run = init_wandb(all_args, run_dir, "wifi_v10_beb_mbps")
