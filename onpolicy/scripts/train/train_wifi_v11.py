#!/usr/bin/env python
"""Train MAPPO on the WiFi v11 continuous-queue WiFi environment."""
...
from onpolicy.envs.wifi_v11.wifi_env import WiFiEnvV11
...
def parse_args(args, parser):
    ...
    parser.add_argument(
        ...
        type=float,
        default=9e-6,
        help="Duration of one simulated slot in seconds for fixed-time v11 episodes.",
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "If set, end each WiFi v11 episode after this much simulated time "
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Per-MLD queue capacity. Defaults to round_length * 2.",
    )
    parser.add_argument(
        "--wandb_project",
        type=str,
        default="wifi_v11",
        help="Weights & Biases project name for WiFi v11 runs",
    )
    parser.add_argument(
        "--wandb_entity",
        type=str,
...
def main(args):
    ...
    setproctitle.setproctitle(
        f"{all_args.algorithm_name}-wifi-v11-{all_args.experiment_name}"
    )
    ...
    from onpolicy.runner.shared.wifi_v11_round_runner import WiFiV11RoundRunner as Runner
