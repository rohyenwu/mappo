#!/usr/bin/env python
"""Train MAPPO on the WiFi v10 independently scheduled link environment."""
...
def parse_args(args, parser):
    ...
    parser.add_argument(
        ...
        type=float,
        default=9e-6,
        help="Duration of one simulated slot in seconds for fixed-time v10 episodes.",
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "If set, end each WiFi v10 episode after this much simulated time "
    ...
    parser.add_argument(
        ...
        type=str,
        default="wifi_v10",
        help="Weights & Biases project name for WiFi v10 runs",
    )
    parser.add_argument(
        "--wandb_entity",
        type=str,
...
def main(args):
    ...
    setproctitle.setproctitle(
        f"{all_args.algorithm_name}-wifi-v10-{all_args.experiment_name}"
    )
    ...
    from onpolicy.runner.shared.wifi_v10_round_runner import WiFiV10RoundRunner as Runner
